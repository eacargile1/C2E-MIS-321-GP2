...
namespace C2E.Api.Data.Migrations
{
    ...
    [Migration("20260423035621_TimesheetWeekApprovalSubmittedHours")]
    partial class TimesheetWeekApprovalSubmittedHours
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("C2E.Api.Models.IssuedInvoice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("ProjectId", "IssuedAtUtc");

                    b.ToTable("IssuedInvoices");
                });

            modelBuilder.Entity("C2E.Api.Models.IssuedInvoiceLine", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("C2E.Api.Models.TimesheetWeekApproval", b =>
                {
                    ...
                    b.Property<decimal?>("SubmittedBillableHours")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");

                    b.Property<decimal?>("SubmittedTotalHours")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
            ...
            modelBuilder.Entity("C2E.Api.Models.IssuedInvoice", b =>
                {
                    b.HasOne("C2E.Api.Models.AppUser", "IssuedBy")
                        .WithMany()
                        .HasForeignKey("IssuedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("C2E.Api.Models.AppUser", "Payee")
                        .WithMany()
            ...
            modelBuilder.Entity("C2E.Api.Models.IssuedInvoiceLine", b =>
                {
                    b.HasOne("C2E.Api.Models.ExpenseEntry", "ExpenseEntry")
                        .WithMany()
                        .HasForeignKey("ExpenseEntryId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("C2E.Api.Models.IssuedInvoice", "IssuedInvoice")
                        .WithMany("Lines")
